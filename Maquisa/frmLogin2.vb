Public Class frmLogin2
    ...
    End Sub
    Private Sub VALIDAR()
        Dim SQLUSER As New SqlClient.SqlCommand("SELECT U.EMPRESA, S.CLAVE SUCURSAL,U.NIVEL, E.NOMBRECOMUN,E.CIUDAD,U.USUARIO FROM USUARIOS U  INNER JOIN EMPRESAS E ON U.EMPRESA=E.CLAVE  INNER JOIN SUCURSAL S ON E.CLAVE=S.EMPRESA WHERE U.PASSWORD='" + TXTPWD.Text + "'", frmPrincipal.CONX)
