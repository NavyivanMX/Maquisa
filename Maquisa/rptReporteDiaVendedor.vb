...
Public Class rptReporteDiaVendedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReporteDiaVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Maquisa.rptReporteDiaVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteDiaVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteDiaVendedor = New rptReporteDiaVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
