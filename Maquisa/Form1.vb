Public Class frmPrincipal
    ...
    Private Sub AgendarVisitaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AgendarVisitaToolStripMenuItem.Click
        Dim VAV As New frmAgendar
        VAV.ShowDialog()
    End Sub
