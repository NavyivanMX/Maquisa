Public Class frmInfoVisita
    Public VISITA As Integer
    Private Sub frmInfoVisita_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGADATOS()
        ...
        'ACTIVAR(False)
        Dim QUERY As String
        QUERY = "SELECT * FROM VINFOVISITA WHERE VISITA='" + VISITA.ToString + "' "
